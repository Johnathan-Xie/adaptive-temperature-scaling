...
from llmtuner.train.calibration import run_calibration
...
def run_exp(args: Optional[Dict[str, Any]] = None, callbacks: Optional[List["TrainerCallback"]] = None):
    ...
    elif finetuning_args.stage == "calibration": # Note currently this is the exact same as sft
        run_calibration(model_args, data_args, training_args, finetuning_args, generating_args, callbacks)
